...
import { Address, EventFilter, BlockTag, TransactionResponse, TransactionRequest, TransactionStatus, Token, PriorityOpResponse, BalancesMap, MessageProof, TransactionReceipt, Block, BlockWithTransactions, Log, TransactionDetails, BatchDetails, BatchDetailsWithOffchainVerification, BlockDetails, ContractAccountInfo } from './types';
...
export declare class Provider extends ethers.providers.JsonRpcProvider {
    ...
    getL1BatchDetailsWithOffchainVerification(number: number): Promise<BatchDetailsWithOffchainVerification>;
