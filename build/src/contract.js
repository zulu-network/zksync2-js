...
class ContractFactory extends ethers_1.ethers.ContractFactory {
    ...
    getDeployTransaction(...args) {
        ...
        txRequest.customData ?? (txRequest.customData = {});
        (_a = txRequest.customData).factoryDeps ?? (_a.factoryDeps = []);
        (_b = txRequest.customData).gasPerPubdata ?? (_b.gasPerPubdata = utils_1.DEFAULT_GAS_PER_PUBDATA_LIMIT);
